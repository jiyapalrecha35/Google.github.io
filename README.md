...
| 2       | Optimizing Network Traffic in Google Services                       | Ford-Fulkerson Algorithm                             | O(E * V^2), O(V^2)         |
| 3       | Range Query Optimization                                            | Segment Trees                                        | O(log N), O(N)             |
| 4       | Allocation of resources in data centres                             | Assignment Problem                                   | O(2^N * N), O(N^2)         |
...
| 23      | Ad Allocation in Google Ads                                         | Assignment Problem                                   | O(2^N * N), O(N^2)          |
...
| 36      | Optimise the video streaming paths on Youtube                      | Floyd-Warshall Algorithm                             | O(V^3), O(V^2)              |
